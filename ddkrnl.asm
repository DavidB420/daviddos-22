;DavidDOS 2.2 kernel Made by David Badiei
org 0000h
...
;Check for AUTOEX.CFG
cmp byte [firstboot],0
jnz continuebooting
call chkforautoex
...
text_string db 'DavidDOS 2.2 Copyright (C) 2020 David Badiei', 0x0D, 0x0A, 0
text_string1 db '===============================================================================', 0
